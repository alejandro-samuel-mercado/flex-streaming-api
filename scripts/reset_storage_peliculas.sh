#!/bin/bash
# =============================================================================
# reset_storage_peliculas.sh
# Limpia TODOS los archivos procesados del servidor de PELÍCULAS.
# Los videos originales en /home/media/peliculas NO se tocan.
# =============================================================================
set -euo pipefail
...
ORIGINALS_DIR="/home/media/peliculas"

echo ""
echo "╔══════════════════════════════════════════════════════╗"
echo "║   RESET STORAGE — SERVIDOR DE PELÍCULAS              ║"
echo "╚══════════════════════════════════════════════════════╝"
echo ""
...
echo ""
echo "🗑️  Borrando HLS de películas..."
if [ -d "$HLS_DIR" ]; then
  rm -rf "${HLS_DIR:?}"/*
  echo "   ✅ $HLS_DIR limpio"
else
...
echo ""
echo "✅ Disco de PELÍCULAS limpio. Listo para re-escanear."
echo "   Próximo paso: ejecutar reset_catalogo_completo.ts y luego escanear_peliculas.ts"
echo ""
