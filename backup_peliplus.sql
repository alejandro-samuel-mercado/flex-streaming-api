...
faq_items	[{"question":"¿Cómo puedo suscribirme a Nuba?","answer":"Puedes elegir el plan que más te convenga en la sección de planes y contactarnos por WhatsApp. Te crearemos una cuenta y podrás empezar a disfrutar de todo el contenido."},{"question":"¿Qué métodos de pago aceptan?","answer":"Aceptamos transferencias bancarias, Mercado Pago, PayPal y pagos en efectivo. Contáctanos por WhatsApp para más detalles."},{"question":"¿Puedo ver contenido gratis?","answer":"Sí, tenemos una selección de contenido gratuito disponible para todos. Solo necesitas crear una cuenta gratuita para empezar a disfrutarlo."},{"question":"¿En cuántos dispositivos puedo ver?","answer":"Depende del plan que elijas. El plan Básico permite 1 dispositivo, el Premium hasta 3 y el Familiar hasta 5 dispositivos simultáneos."}]	2026-04-29 23:38:50.553
